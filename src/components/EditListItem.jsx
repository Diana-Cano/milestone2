...
function EditListItem(props) {
    ...
    useEffect(() => {
        const fetchThisList = async () => {
            const response = await fetch(`https://buck-it-back-end.vercel.app/api/lists/${props.id}`)
    ...
    async function handleSubmit(e) {
        ...
        try {
            const response = await fetch(`https://buck-it-back-end.vercel.app/api/lists/${list.list_id}`, {
                method: "PUT",
                headers: {
